...
func (s Suggestion) Words(prefix string) slice.Slice[string] {
	return slice.TransformSlice(s.Terminals, nil, func(term, idx int) (string, bool) {
		return prefix + s.Word[:term+1], true
	})
}
