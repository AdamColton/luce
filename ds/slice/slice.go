...
func Transform[In, Out any](in iter.Iter[In], fn func(In) (Out, bool)) Slice[Out] {
...
// is a bool indicating if the returned value should be included in the result.
// The returned Slice is sized exactly to the output.
func TransformSlice[In, Out any](in []In, fn func(In) (Out, bool)) Slice[Out] {
	return transform(0, NewIter(in), fn)
}

func transform[In, Out any](size int, in iter.Iter[In], fn func(In) (Out, bool)) Slice[Out] {
