...
func TestReadDirNames(t *testing.T) {
	...
	expected := []string{
		...
		"handlers.go", "handlers_test.go", "iterator.go", "lfilemock",
		"match.go", "match_test.go", "multiglob.go", "multiglob_test.go",
		"path.go", "path_test.go", "paths.go", "paths_test.go", "repository.go",
