...
// Slice copies all the values from vals that pass the filter into buf and
// returns that. Because this is done in order it's fine to do
// vals = f.Slice(vals, vals)
