...
func (si StoreIndex[E]) Lookup(idxKey []byte) (entIds iter.Iter[[]byte], err error) {
	defer func() {
		err, _ = recover().(error)
	}()
...
func (si StoreIndex[E]) Search(f filter.Filter[[]byte]) (idxKeys iter.Iter[[]byte], err error) {
...
func (si StoreIndex[E]) MultiLookup(idxKeys iter.Iter[[]byte]) (entIds iter.Iter[[]byte], err error) {
...
func (si StoreIndex[E]) MultiEntLookup(idxKeys iter.Iter[[]byte]) (ents slice.Slice[E], err error) {
