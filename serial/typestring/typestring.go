...
// PrefixInterfaceType casts i to TypeIDStringer and prefixes 4 bytes with that
// value.
...
// TypeMap tracks the mapping between types and their string values.
