...
// WriterSerializer fulfills serial.TypeMap. Helper that allows it take a
// WriterSerializer func and serialize to it.
...
// ReaderDeserializer fulfills serial.TypeMap. Helper that allows it toake a
// ReaderDeserializer func and Deserialize to it.
