...
// TestingT represents the methods on *testing.T that are used in this package.
// This allows wrappers and mocks to be used as well as *testing.T.
...
func AssertEqual(expected, actual interface{}, delta cmpr.Tolerance) error {
	...
	if t.Kind() != reflect.Ptr {
		if p := reflect.PointerTo(t); p.Implements(equalType) {
