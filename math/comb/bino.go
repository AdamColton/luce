...
// Memo is pre-populated with the first 256 values.
...
// Pascals triangle produces binomails.
// It has a vertical line of symmetry represented by
//   if i > n/2
//
// The leftmost diagonal is always one
// and the second diagonal increments.
